Contributing to GKC Core
============================

The GKC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GKC Core project, and is not to be
confused with overall GKC Network Protocol consensus changes.

Whether a pull request is merged into GKC Core rests with the project merge
...
Patches that change GKC consensus rules are considerably more involved than
...
Where a patch set proposes to change the GKC consensus, it must have been
...
The project leader is the release manager for each GKC Core release.
