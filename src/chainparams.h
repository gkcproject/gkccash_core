 ...
 * GKC system. There are three: the main network on which people trade goods
...
public:
    ...
    const uint256& ProofOfStakeLimit(const bool fV2) const;
    ...
    int Contract_StartHeight() const;
