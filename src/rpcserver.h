...
extern UniValue banappnode(const UniValue& params, bool fHelp);
...
extern UniValue posminer(const UniValue& params, bool fHelp);
...
extern UniValue selectutxotosend(const UniValue& params, bool fHelp);
...
extern UniValue selectutxotosendmany(const UniValue& params, bool fHelp);
...
extern UniValue getkeyid(const UniValue& params, bool fHelp);
...
extern UniValue getblockbalance(const UniValue& params, bool fHelp);
...
extern UniValue gettokeninfo(const UniValue& params, bool fHelp);
...
#ifdef DPOS
extern UniValue createentrustagent(const UniValue& params, bool fHelp);
extern UniValue listmyagentid(const UniValue& params, bool fHelp);
extern UniValue resignagent(const UniValue& params, bool fHelp);
extern UniValue entrust(const UniValue& params, bool fHelp);
extern UniValue entrustwithcomment(const UniValue& params, bool fHelp);
extern UniValue deprive(const UniValue& params, bool fHelp);
extern UniValue getentrustment(const UniValue& params, bool fHelp);
extern UniValue getentrustlockheight(const UniValue& params, bool fHelp);
extern UniValue listagents(const UniValue& params, bool fHelp);
extern UniValue getagent(const UniValue& params, bool fHelp);
extern UniValue listentrusts(const UniValue& params, bool fHelp);
extern UniValue getcurrentseason(const UniValue& params, bool fHelp);
extern UniValue listdeprives(const UniValue& params, bool fHelp);
extern UniValue listentrustrewards(const UniValue& params, bool fHelp);
...
// advertisement
extern UniValue sendadvertise(const UniValue& params, bool fHelp);
extern UniValue sendsysmessage(const UniValue& params, bool fHelp);
extern UniValue filteradtx(const UniValue& params, bool fHelp);
extern UniValue getadadmin(const UniValue& params, bool fHelp);
extern UniValue listad(const UniValue& params, bool fHelp);
