...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"network", "banappnode", &banappnode, true, false, false},
		...
		{"blockchain", "getblockbalance", &getblockbalance, true, false, false},
        {"blockchain", "gettxexplorer", &gettxexplorer, true, false, false},
        {"blockchain", "getaddressexplorer", &getaddressexplorer, true, false, false},
		{"blockchain", "getaddressbalance", &getaddressbalance, true, false, false},
		...
		{"blockchain", "gettokeninfo", &gettokeninfo,},
        ...
        {"generating", "posminer", &posminer, true, true, false},
#endif
		...
		{"rawtransactions", "getkeyid", &getkeyid, true, true, false},
        ...
        /* Gkc features */
        {"gkc", "masternode", &masternode, true, true, false},
        {"gkc", "listmasternodes", &listmasternodes, true, true, false},
        {"gkc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gkc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gkc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gkc", "masternodedebug", &masternodedebug, true, true, false},
        {"gkc", "startmasternode", &startmasternode, true, true, false},
        {"gkc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gkc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gkc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gkc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gkc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gkc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gkc", "mnbudget", &mnbudget, true, true, false},
        {"gkc", "preparebudget", &preparebudget, true, true, false},
        {"gkc", "submitbudget", &submitbudget, true, true, false},
        {"gkc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gkc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gkc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gkc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gkc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gkc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gkc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gkc", "checkbudgets", &checkbudgets, true, true, false},
        ...
        {"wallet", "selectutxotosendmany", &selectutxotosendmany, false, false, true},
        {"wallet", "sendtoaddress", &sendtoaddress, false, false, true},
        {"wallet", "sendtoaddressix", &sendtoaddressix, false, false, true},
        {"wallet", "selectutxotosend", &selectutxotosend, false, false, true},
		{"wallet", "sendadvertise", &sendadvertise, false, false, true},
		{"wallet", "sendsysmessage", &sendsysmessage, false, false, true},
		{"wallet", "filteradtx", &filteradtx, false, false, true},
		{"wallet", "getadadmin", &getadadmin, false, false, true},
		{"wallet", "listad", &listad, false, false, true},
		{"wallet", "listsysmsg", &listsysmsg, false, false, true},
		{"wallet", "listadfilter", &listadfilter, false, false, true},
		...
		{"wallet", "getagent", &getagent, false, false, true},
		{"wallet", "listentrusts", &listentrusts, false, false, true},
		{"wallet", "getcurrentseason", &getcurrentseason, false, false, true},
		{"wallet", "listdeprives", &listdeprives, false, false, true},
		{"wallet", "listentrustrewards", &listentrustrewards, false, false, true},
    ...
    try {
        ...
        UniValue result;
        {
            if (pcmd->threadSafe)
				...
				int64_t begin = GetTimeMillis();
				int64_t timeout = GetArg("-rpctimeout", 10000);
                while (true) {
                    TRY_LOCK(cs_main, lockMain);
                    if (!lockMain) {
						int64_t check = GetTimeMillis();
						if(check - begin > timeout)
							throw JSONRPCError(RPC_MISC_ERROR, "Resource(cs_main) busy");
                        MilliSleep(50);
                        continue;
                    }
                    while (true) {
                        ...
                        if (!lockMain) {
							int64_t check = GetTimeMillis();
							if(check - begin > timeout)
								throw JSONRPCError(RPC_MISC_ERROR, "Resource(cs_wallet) busy");
                            MilliSleep(50);
                            continue;
                        }
                        result = pcmd->actor(params, false);
		...
		LogPrint("clock","CRPCTable::execute | info,clock | method=%s, params=%s, time=%lld\n",strMethod,params.write(),clock_end-clock_begin);
        return result;
    } catch (std::exception& e) {
...
{
    return "> gkc-cli " + methodname + " " + args + "\n";
}
