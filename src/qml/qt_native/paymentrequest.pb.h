...
#ifndef PROTOBUF_qt_5fnative_2fpaymentrequest_2eproto__INCLUDED
#define PROTOBUF_qt_5fnative_2fpaymentrequest_2eproto__INCLUDED
...
class Output : public ::google::protobuf::Message {
 ...
 private:
  ...
  ::std::string* script_;
  friend void  protobuf_AddDesc_qt_5fnative_2fpaymentrequest_2eproto();
  friend void protobuf_AssignDesc_qt_5fnative_2fpaymentrequest_2eproto();
  friend void protobuf_ShutdownFile_qt_5fnative_2fpaymentrequest_2eproto();
...
#endif  // PROTOBUF_qt_5fnative_2fpaymentrequest_2eproto__INCLUDED
