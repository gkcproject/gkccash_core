/****************************************************************************
** Meta object code from reading C++ file 'lightwallet.h'
**
...
#error "The header file 'lightwallet.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LightWallet_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject LightWallet::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_LightWallet.data,
      qt_meta_data_LightWallet,  qt_static_metacall, nullptr, nullptr}
};
...
void *LightWallet::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LightWallet.stringdata0))
