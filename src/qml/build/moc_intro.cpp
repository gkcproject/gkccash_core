...
struct qt_meta_stringdata_MnemonicThread_t {
    QByteArrayData data[3];
    char stringdata0[28];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MnemonicThread_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MnemonicThread_t qt_meta_stringdata_MnemonicThread = {
    {
QT_MOC_LITERAL(0, 0, 14), // "MnemonicThread"
QT_MOC_LITERAL(1, 15, 11), // "closeThread"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "MnemonicThread\0closeThread\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_MnemonicThread[] = {
...
void MnemonicThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MnemonicThread *_t = static_cast<MnemonicThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->closeThread(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject MnemonicThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_MnemonicThread.data,
      qt_meta_data_MnemonicThread,  qt_static_metacall, nullptr, nullptr}
};


const QMetaObject *MnemonicThread::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *MnemonicThread::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_MnemonicThread.stringdata0))
        return static_cast<void*>(this);
    return QThread::qt_metacast(_clname);
}

int MnemonicThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
