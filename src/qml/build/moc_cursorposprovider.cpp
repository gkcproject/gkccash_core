...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CursorPosProvider_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CursorPosProvider_t qt_meta_stringdata_CursorPosProvider = {
    {
QT_MOC_LITERAL(0, 0, 17), // "CursorPosProvider"
QT_MOC_LITERAL(1, 18, 9), // "cursorPos"
...
void CursorPosProvider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CursorPosProvider *_t = static_cast<CursorPosProvider *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject CursorPosProvider::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CursorPosProvider.data,
      qt_meta_data_CursorPosProvider,  qt_static_metacall, nullptr, nullptr}
};
