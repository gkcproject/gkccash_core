...
QT_MOC_LITERAL(8, 72, 12), // "client_model"
QT_MOC_LITERAL(9, 85, 12), // "ClientModel*"
QT_MOC_LITERAL(10, 98, 9) // "range_min"

    },
    "TrafficGraphWidget\0updateRates\0\0"
    "setGraphRangeMins\0mins\0clear\0name\0"
    "color\0client_model\0ClientModel*\0"
    "range_min"
};
...
void TrafficGraphWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2:
            *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< ClientModel* >(); break;
        }
    }
        ...
        case 2: *reinterpret_cast< ClientModel**>(_v) = _t->getClientModel(); break;
        case 3: *reinterpret_cast< int*>(_v) = _t->getGraphRangeMins(); break;
        default: break;
        }
        ...
        case 2: _t->setClientModel(*reinterpret_cast< ClientModel**>(_v)); break;
        case 3: _t->setGraphRangeMins(*reinterpret_cast< int*>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject TrafficGraphWidget::staticMetaObject = {
    { &QQuickPaintedItem::staticMetaObject, qt_meta_stringdata_TrafficGraphWidget.data,
