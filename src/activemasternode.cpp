...
//
// Bootup the Masternode, look for a 10000 GKC input and register on the network
//
...
{
	LogPrintf("CActiveMasternode::Register | strService=%s, strKeyMasternode=%s, strTxHash=%s, strOutputIndex=%s\n", 
		strService.c_str(), strKeyMasternode.c_str(), strTxHash.c_str(), strOutputIndex.c_str());
    CTxIn vin;
    CPubKey pubKeyCollateralAddress;
    CKey keyCollateralAddress;
    CPubKey pubKeyMasternode;
...
bool CActiveMasternode::GetMasterNodeVin(CTxIn& vin, CPubKey& pubkey, CKey& secretKey, std::string strTxHash, std::string strOutputIndex)
{
	...
	LogPrintf("%s:%d:%s|fWallet=%d\n",__FILE__,__LINE__,__func__,(bool)fWallet);
