 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called GKC (http://www.gkc.org),
 * which enables instant payments to anyone, anywhere in the world. GKC uses peer-to-peer technology to operate
