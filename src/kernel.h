...
#ifdef DPOS
bool stakeTargetHit(uint256 hashProofOfStake, int64_t nValueIn, uint256 bnTargetPerCoinDay, int blockheight, AgentID agentid);
bool CheckStakeKernelHash(
	...
	int             blockFromHeight, AgentID       agentid);
#else
